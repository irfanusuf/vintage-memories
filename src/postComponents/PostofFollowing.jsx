...
const PostofFollowing = (props) => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const reverseArray = res.data.posts.reverse()
     // const randomizeArray = // set of predefined rules


      if (res.data.message === "post of following") {
...
export default PostofFollowing;
